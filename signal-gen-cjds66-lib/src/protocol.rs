...
// -----
// Set period width.
macro_rules! WRITE_PERIOD_COMMAND {() => {"46"}}
pub const WRITE_PERIOD_COMMAND: &'static str = WRITE_PERIOD_COMMAND!();

// command example:
// 1000 nanoseconds:
//   ":w46=1000,0.\r\n"
macro_rules! WRITE_PERIOD_ARG_NANOSECONDS {() => {"0"}}
pub const WRITE_PERIOD_ARG_NANOSECONDS: &'static str = WRITE_PERIOD_ARG_NANOSECONDS!();

macro_rules! WRITE_PERIOD_ARG_NANOSECONDS_MIN {() => {25.0}}
pub const WRITE_PERIOD_ARG_NANOSECONDS_MIN: f64 = WRITE_PERIOD_ARG_NANOSECONDS_MIN!();

macro_rules! WRITE_PERIOD_ARG_NANOSECONDS_MAX {() => {4000000000.0}}
pub const WRITE_PERIOD_ARG_NANOSECONDS_MAX: f64 = WRITE_PERIOD_ARG_NANOSECONDS_MAX!();

// command example:
// 1000 microseconds:
//   ":w45=1000,1.\r\n"
macro_rules! WRITE_PERIOD_ARG_MICROSECONDS {() => {"1"}}
pub const WRITE_PERIOD_ARG_MICROSECONDS: &'static str = WRITE_PERIOD_ARG_MICROSECONDS!();

macro_rules! WRITE_PERIOD_ARG_MICROSECONDS_MIN {() => {1.0}}
pub const WRITE_PERIOD_ARG_MICROSECONDS_MIN: f64 = WRITE_PERIOD_ARG_MICROSECONDS_MIN!();

macro_rules! WRITE_PERIOD_ARG_MICROSECONDS_MAX {() => {4000000000.0}}
pub const WRITE_PERIOD_ARG_MICROSECONDS_MAX: f64 = WRITE_PERIOD_ARG_MICROSECONDS_MAX!();

macro_rules! WRITE_PERIOD_RES_LEN {() => {6}}
pub const WRITE_PERIOD_RES_LEN: u8 = WRITE_PERIOD_RES_LEN!();
// -----
