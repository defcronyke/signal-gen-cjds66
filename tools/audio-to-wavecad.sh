...
# supports WaveCAD .wav files. So if you use this first, you can 
# have a smaller WaveCAD .wav file with just the data you need in 
# it.
#
...
# the Rust program to regenerate the .txt file if you want.
